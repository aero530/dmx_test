...
use crate::{channels::RouterChannelTx, event_router::RouterEvent, ui::{MenuData, ModuleType}, EepromChannelRx, I2cSharedDev};
...
impl<I2C: I2CTRAIT> Eeprom<I2C> {
    ...
    pub fn new(mut i2c: I2C, address: u8, rx: EepromChannelRx, tx: RouterChannelTx) -> Self {
            ...
            EepromEvent::ReadModuleType => {
                ...
                match data { //.await {
                    Ok(data) => {
                        ...
                        self.tx.try_send(RouterEvent::StoreModuleType(Some(decoded)));
                        
                    },
                    Err(e) => {
                        self.tx.try_send(RouterEvent::StoreModuleType(None));
...
pub async fn eeprom_i2c_task(mut i2c: I2cSharedDev, address: u8, rx: EepromChannelRx, tx: RouterChannelTx) {
