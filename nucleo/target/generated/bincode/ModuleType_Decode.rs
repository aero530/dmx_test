impl < __Context > :: bincode :: Decode < __Context > for ModuleType
{
    ...
    error :: DecodeError >
    {
        ...
        {
            0u32 =>core :: result :: Result :: Ok(Self ::Pwm {}), 1u32 =>core
            :: result :: Result :: Ok(Self ::SmartLed {}), 2u32 =>core ::
            result :: Result :: Ok(Self ::Unknown {}), variant =>core ::
            result :: Result ::
            Err(:: bincode :: error :: DecodeError :: UnexpectedVariant
            {
                found : variant, type_name : "ModuleType", allowed : &::
