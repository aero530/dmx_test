impl < __Context > :: bincode :: Decode < __Context > for ValueType
{
    ...
    error :: DecodeError >
    {
        ...
        {
            0u32 =>core :: result :: Result :: Ok(Self ::None {}), 1u32 =>core
            :: result :: Result ::
            Ok(Self ::U8
            {
            ...
            Ok(Self ::SmartLedGrouping
            {
                0 : :: bincode :: Decode ::< __D :: Context >::
                decode(decoder) ?,
            }), 3u32 =>core :: result :: Result ::
            Ok(Self ::SmartLedColorMode
            {
                0 : :: bincode :: Decode ::< __D :: Context >::
                decode(decoder) ?,
            ...
            {
                found : variant, type_name : "ValueType", allowed : &::
