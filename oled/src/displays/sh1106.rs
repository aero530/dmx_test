//! Sh1106 display variants and specifics
...
/// Generic 64x128 with Sh1106 controller
...
/// Generic 128x128 with Sh1106 controller
#[derive(Debug, Clone, Copy)]
pub struct Sh1106_128_128 {}

impl DisplayVariant for Sh1106_128_128 {
    const WIDTH: u8 = 128;
    const HEIGHT: u8 = 128;
